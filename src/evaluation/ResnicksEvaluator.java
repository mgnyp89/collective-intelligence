...
public class ResnicksEvaluator extends LeaveOneOutBaseEvaluator {

    public ResnicksEvaluator(UserCollection userCollection) {
    ...
    public void runLeaveOneOutLoopTest(int neighbourhoodSize) {
        ...
        try (Writer writer = new BufferedWriter(new OutputStreamWriter(
                new FileOutputStream("./resources/resnicksFormula"+neighbourhoodSize+".csv"), StandardCharsets.UTF_8))) {
            ...
            for (String userId : userRatings.keySet()) {
                ...
                for (String itemId : movieRatings.keySet()) {
                    try {
                        ...
                        predictedRating = statisticsPresenter.getResnicksPrediction(userId, itemId, neighbourhoodSize, similarUsers, USER_COLLECTION);
